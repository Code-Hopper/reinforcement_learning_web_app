    ...
    <div id='login-register-container'>
      ...
      >
        <div className='h-full flex items-center justify-center flex-col gap-5 p-10'>
          ...
          <div className='bg-backgroundLight text-primaryColor hover:bg-backgroundDark hover:text-highlightColor transition-all font-semibold p-3 rounded-full flex gap-3 items-center justify-center'>
            <IoMdLogIn size={25} />
